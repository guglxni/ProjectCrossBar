...
const INTEGRATIONS = [
  ...
  },
  {
    ...
    tag: "Market data",
    body: "CrossBar reads live perp-market reference prices from Flash Trade to contextualize the on-chain oracle band, giving traders a familiar mainnet price alongside the devnet clear.",
    points: [
      "Live reference prices for SOL and majors",
      "Shown next to CrossBar's oracle reference band",
      "Read-only market context, no external custody",
    ],
